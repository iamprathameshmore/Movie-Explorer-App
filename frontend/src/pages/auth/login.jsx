...
function LogIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Log In successful!, Please Check Your Mail.");
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div className="flex justify-between bg-red-50 items-center">
                <p className="text-red-500 text-semibold p-3 bg-red-50">
                  {error}
                </p>
                <Link
                  to=""
                  className="text-red-500 text-semibold p-3 bg-red-50 mr-2"
